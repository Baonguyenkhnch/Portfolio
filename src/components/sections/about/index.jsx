        ...
        <>
            <Row>
                <Col md={6} xs={12}>
                    ...
                    <div>
                        <div>
                            <p> Hi Everyone, I am BaoNguyen from Ho Chi Minh, VietNam.</p>

                            <p> I am currently employed as a a Frontend dev .</p>

                            <p> I am currently a fourth year student at the university of sciences, majoring in Computer Physics.</p>
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div className="experience-container">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="company">  University &  of   Science   (US)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
