...
const Introduction = () => {
  ...
  return (
    <section className='introduction-section my-5 my-md-7'>
      <Row>
        <Col xs={12} md={9}>
          ...
          <p>
            ...
            <i><b className='text-pink-100'>Java {t("introSection.and")} Javascript</b></i>.
            <br /><br />
            {t("introSection.heading3")}{" "}
            <i><b className='text-pink-100'>{t("introSection.heading4")}</b></i>
            <br /><br />
            {t("introSection.heading5")}{" "}
            <i><b className='text-pink-100'>Java Spring</b></i> {t("introSection.and")}{" "}
            <i><b className='text-pink-100'>Node.js</b></i>
          </p>
        </Col>
